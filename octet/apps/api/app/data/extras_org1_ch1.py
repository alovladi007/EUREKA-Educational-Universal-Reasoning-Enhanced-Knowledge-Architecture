    ...
    sections=(
        ...
        ReadingSection(
            ...
            body=(
                ...
                "predicts.\n\n"
                "The counting rule is a default, and it matters which "
                "direction the inference runs when the default fails. The "
                "rule predicts; geometry decides. An amide nitrogen counts "
                "four groups - three bonds and a lone pair - and the rule "
                "says $sp^3$, pyramidal. The measured molecule says "
                "otherwise: the nitrogen and all three of its substituents "
                "lie in the carbonyl's plane, and rotation about the C-N "
                "bond is restricted in a way no ordinary single bond is. The "
                "plane is the evidence, and the explanation is that the lone "
                "pair has moved into the unhybridised $p$ orbital of an "
                "$sp^2$ nitrogen, where it is parallel to the carbonyl "
                "$\\pi$ system and can delocalise into it. The general "
                "version is worth having: whenever a lone pair sits adjacent "
                "to a $\\pi$ system, placing it in a $p$ orbital buys "
                "delocalisation, and the atom adopts the $sp^2$ arrangement "
                "that makes a $p$ orbital available. So when the count and "
                "the observed geometry disagree, the geometry wins - and the "
                "disagreement is not noise but a signal, because the "
                "mismatch itself is telling you delocalisation is operating."
            ),
            table=Table(
    ...
    sections=(
        ReadingSection(
            ...
            body=(
                ...
                "The hydrogen inference assumes the carbon is neutral, and a "
                "drawn charge overrides it. A plain vertex with two lines "
                "carries two hydrogens; the same vertex marked with a plus "
                "carries one, because a carbocation carbon has three bonds "
                "in total, not four - check it by the count, "
                "$4 - 0 - 3 = +1$. A vertex marked with a minus also carries "
                "one hydrogen, since a carbanion has three bonds and a lone "
                "pair: $4 - 2 - 3 = -1$. A radical dot does the same, three "
                "bonds and a single electron. In each case the symbol is "
                "doing the work a written H would otherwise do, so read the "
                "charges before you count the hydrogens, not after."
            ),
            figure=Figure(
        ...
        ReadingSection(
            ...
            body=(
                ...
                "And one further omission bites hardest during mechanisms: "
                "lone pairs. The convention draws heteroatoms but not their "
                "non-bonding electrons, and those electrons are still there "
                "- two pairs on an alcohol or ether oxygen, one on an amine "
                "nitrogen, three on a halogen - and they are frequently the "
                "most reactive electrons in the molecule. Every mechanism "
                "that begins with a nucleophilic attack begins, on paper, "
                "with an arrow whose tail sits on a lone pair the skeletal "
                "drawing never showed. The working habit is to restore them "
                "the moment an atom enters the chemistry: before drawing an "
                "arrow from an oxygen, put its pairs back explicitly and "
                "take the tail from one of them, exactly as you restore the "
                "hydrogen count before deprotonating a carbon. A drawing "
                "that omits something is safe only while you remember that "
                "it does."
            ),
        ),
        ReadingSection(
    ...
    sections=(
        ReadingSection(
            ...
            body=(
                ...
                "of wrong answers.\n\n"
                "Run both counts on one atom and the gap stops being "
                "abstract. Take the oxygen of hydronium: three bonds, one "
                "lone pair. Formal charge splits every bond evenly, so this "
                "oxygen owns its 2 non-bonding electrons plus half of the 6 "
                "bonding electrons, 5 in all, and "
                "$\\mathrm{FC} = 6 - 5 = +1$. Oxidation state hands every "
                "bond to the more electronegative atom, and oxygen beats "
                "hydrogen every time, so the same oxygen owns all 6 bonding "
                "electrons plus its lone pair, 8 in all, for an oxidation "
                "state of $6 - 8 = -2$. One atom, one structure, and the two "
                "conventions sit three units apart - because they answer "
                "different questions. Formal charge says this oxygen's "
                "connectivity is the connectivity of a cationic oxygen, "
                "which is why hydronium behaves as a strong acid. Oxidation "
                "state says the bonding electrons live mostly on oxygen, "
                "which is what a redox balance needs to know. Notice too "
                "that protonating water changed the oxygen's formal charge "
                "from 0 to +1 while its oxidation state stayed at -2 "
                "throughout: acid-base chemistry moves protons, not "
                "electrons, and only the count built to track connectivity "
                "registers it. So the working rule: asked whether something "
                "was oxidised, count oxidation states; asked which resonance "
                "structure dominates or where a mechanism's charge went, "
                "count formal charge. The numbers are not interchangeable "
    ...
    sections=(
        ...
        ReadingSection(
            ...
            body=(
                ...
                "Be equally literal about what the curved arrows mean here, "
                "because the same symbol does a different job in a "
                "mechanism. A mechanism arrow describes an event: electrons "
                "genuinely relocate, in time, as one species turns into "
                "another. A resonance arrow describes no event at all. It is "
                "an instruction for converting one drawing into another "
                "drawing of the same unchanging object - take the pair drawn "
                "here, draw it there instead - and nothing in the molecule "
                "moves while you follow it. There is no before and no after. "
                "The molecule was the hybrid before you drew the first "
                "structure and is still the hybrid after the last; the "
                "arrows organise your bookkeeping, not its behaviour. "
                "Reading them as motion is how the equilibrium misconception "
                "of the first section gets rebuilt inside the notation "
                "itself.\n\n"
                "Hydrogen is the atom that slips past the nuclei-never-move "
                "test most often, because it is small and easy to slide "
                "without noticing. Moving a proton gives a tautomer, not a "
                "resonance structure: the keto and enol forms of a carbonyl "
                "compound differ in where a hydrogen and a double bond sit, "
                "so they are distinct constitutional isomers with different "
                "connectivity, interconverting in a genuine equilibrium with "
                "a genuine rate - everything resonance is not. And remember "
                "that the skeletal convention is hiding most of the "
                "hydrogens: an implicit H that moved is still a moved atom. "
                "The mechanical test is worth running every time: cover the "
                "electrons, compare the two skeletons atom by atom, "
                "hydrogens included. Any nucleus in a different place means "
                "isomers, and the honest symbol between isomers is the "
                "equilibrium arrow."
            ),
        ),
        ReadingSection(
