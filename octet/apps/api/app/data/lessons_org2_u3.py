...
LESSONS_ORG2_U3 = {
    ...
    "ORG2.EASREACTIONS": Lesson(
        ...
        core_idea=(
            ...
            "nitronium ion, a linear cation formed conceptually by protonation "
            "and loss of water from nitric acid; the ring then substitutes a "
            "single nitro group for a hydrogen. Sulfonation uses sulfur "
        ...
        try_it_answer=(
            ...
            "simply appended a group that had unsaturation of its own."
        ),
        pitfall=(
    ...
    "ORG2.DIRECTING": Lesson(
        ...
        worked_example=(
            ...
            "so its protons fall into just three environments, in the ratio "
    ...
    "ORG2.MULTIPLESUB": Lesson(
        ...
        worked_example=(
            ...
            "and its three ring protons are all equivalent, giving just two "
