/**
 * MCAT course content — 52 topics with deep lesson content.
 * AI-generated. Requires SME review.
 */

import type { QuizQuestion } from '@/components/test-prep/cissp/LessonQuiz';

import { MCAT_BIOCHEM1A_LESSONS } from './mcat-biochem1a-data';
import { MCAT_BIOCHEM1B_LESSONS } from './mcat-biochem1b-data';
...
import { MCAT_BIOCHEM2E_LESSONS } from './mcat-biochem2e-data';
...
> **Mnemonic:** "**R**abbits **M**unch **I**n **V**ery **U**nusual e**X**pensive **G**ardens"`,
  ...
  ...MCAT_BIOCHEM1A_LESSONS,
  ...MCAT_BIOCHEM1B_LESSONS,
  ...MCAT_BIOCHEM1C_LESSONS,
...
> **Mnemonic for H-W conditions:** "**M**utant **S**elective **F**lying **D**rifting **M**aters" — the five conditions that, when present, violate Hardy-Weinberg equilibrium.`,
  ...
  // Biochemistry II chapters II.1–II.15 live in their own data files:
  // metabolism (2A/2B), the information-flow chapters (2C/2D), and
  // DNA technology (2E).
  ...MCAT_BIOCHEM2A_LESSONS,
  ...MCAT_BIOCHEM2B_LESSONS,
  ...MCAT_BIOCHEM2C_LESSONS,
  ...MCAT_BIOCHEM2D_LESSONS,
  ...MCAT_BIOCHEM2E_LESSONS,
