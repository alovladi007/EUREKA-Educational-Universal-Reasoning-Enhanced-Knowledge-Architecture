...
const CISSP: ExamCurriculum = [
  // Structure follows the CISSP Instructor Edition module map exactly:
  // 8 domains, 72 modules, each domain closing with a Domain Review.
  // Source of truth: scripts/cissp_module_map.py (extracted from the PDF).
  // Weights are the official (ISC)2 outline effective 2024-04-15.
  { sectionId: 'd1_security_risk', sectionName: 'Domain 1: Security and Risk Management (16%)', topics: [
    t('cissp_cia_concepts', '1. Concepts of Confidentiality, Integrity, and Availability', 'The CIA triad as the organising frame - confidentiality, integrity, availability, plus authenticity and non-repudiation; DAD as its inverse.'),
    t('cissp_governance', '2. Organizational and Corporate Governance', 'Security policies, standards, procedures, and organizational roles.'),
    t('cissp_risk_mgmt', '3. Risk Management Concepts', 'Risk identification, analysis (quantitative & qualitative), treatment, and monitoring.'),
    t('cissp_compliance', '4. Compliance Requirements', 'Regulations (GDPR, HIPAA), intellectual property, privacy, and investigations.'),
    t('cissp_legal_global', '5. Legal and Regulatory Issues in a Global Context', 'Cybercrime and data breach law across jurisdictions, import/export controls, transborder data flow, intellectual property, and contractual obligations.'),
    t('cissp_policy_framework', '6. Security Policy, Standards, Procedures, and Guidelines', 'The document hierarchy - policy, standard, procedure, guideline, baseline - who authors each, which are mandatory, and how they are reviewed.'),
    t('cissp_personnel', '7. Personnel Security Policies and Procedures', 'Hiring, training, termination, and third-party management.'),
    t('cissp_awareness', '8. Security Awareness, Education, and Training Programs', 'Programme design, role-based content, phishing simulation, measuring effectiveness, and building security culture.'),
    t('cissp_bcdr', '9. Business Continuity Requirements', 'BIA, BCP, DRP, testing, and recovery strategies.'),
    t('cissp_ethics', '10. Professional Ethics', 'The (ISC)2 Code of Professional Ethics canons in order of precedence, the complaint process, and organisational codes of conduct.'),
    t('cissp_d1_review', '11. Domain 1 Review', 'Domain 1 consolidation - the cross-module links, the traps, and a full-length review set.'),
  ]},
  { sectionId: 'd2_asset_security', sectionName: 'Domain 2: Asset Security (10%)', topics: [
    t('cissp_data_class', '1. Information and Assets', 'Classification levels, labeling, retention, and destruction.'),
    t('cissp_data_lifecycle', '2. Asset Lifecycle', 'Data states (rest/transit/use), sanitization (DoD 5220.22-M, NIST 800-88), retention, secure deletion, media destruction. CBK D2 gap fix.'),
    t('cissp_asset_ownership', '3. Information and Asset Ownership', 'Data owner, data controller, data processor, custodian, steward and user - who decides, who implements, who is accountable.'),
    t('cissp_privacy', '4. Protect Privacy', 'Data ownership, privacy controls, and data lifecycle management.'),
    t('cissp_asset_retention', '5. Asset Retention', 'Retention driven by legal, regulatory and business need; schedules, legal hold, and the risk of retaining too long.'),
    t('cissp_data_controls', '6. Data Security Controls', 'Controls selected by data state - at rest, in transit, in use - including encryption, tokenisation, masking, and DLP.'),
    t('cissp_asset_handling', '7. Information and Asset Handling Requirements', 'Marking, labelling, storage, transport and declassification requirements that follow a classification decision.'),
    t('cissp_data_remanence', '8. Data Remanence', 'Residual data after deletion; clearing, purging, degaussing, cryptographic erase and physical destruction, per NIST SP 800-88.'),
    t('cissp_d2_review', '9. Domain 2 Review', 'Domain 2 consolidation - the cross-module links, the traps, and a full-length review set.'),
  ]},
  { sectionId: 'd3_architecture', sectionName: 'Domain 3: Security Architecture and Engineering (13%)', topics: [
    t('cissp_secure_design', '1. Processes Using Secure Design Principles', 'Defense in depth, least privilege, separation of duties, and fail-safe defaults.'),
    t('cissp_models', '2. Fundamental Concepts of Security Models', 'Bell-LaPadula, Biba, Clark-Wilson, and Brewer-Nash models.'),
    t('cissp_evaluation', '3. Select Controls Based upon System Security Requirements', 'Common Criteria (EAL1-7), Protection Profiles, Security Targets, TCSEC (Orange Book), ITSEC, FIPS 140-3. CBK D3 gap fix.'),
    t('cissp_system_capabilities', '4. Security Capabilities of Information Systems', 'Memory protection, TPM, secure boot, virtualisation and hypervisor types, trusted platform capabilities, and cryptographic modules.'),
    t('cissp_arch_vulns', '5. Vulnerabilities of Security Architectures, Designs, and Solution Elements', 'Weaknesses by architecture class - client/server, database, industrial control, cloud, containers, embedded, IoT - and their characteristic exposures.'),
    t('cissp_crypto', '6. Cryptography', 'Symmetric, asymmetric, hashing, PKI, digital signatures, and key management.'),
    t('cissp_physical', '7. Physical Security', 'Site selection, perimeter, surveillance, environmental controls, and fire suppression.'),
    t('cissp_d3_review', '8. Domain 3 Review', 'Domain 3 consolidation - the cross-module links, the traps, and a full-length review set.'),
  ]},
  { sectionId: 'd4_network', sectionName: 'Domain 4: Communication and Network Security (13%)', topics: [
    t('cissp_network', '1. Secure Design Principles in Network Architectures', 'OSI/TCP-IP models, segmentation, SDN, and network devices.'),
    t('cissp_osi_l1', '2. OSI Layer 1: Physical Layer', 'Layer 1: media, signalling, connectors and topologies; wiretapping, jamming and emanation, and the physical controls that answer them.'),
    t('cissp_osi_l2', '3. OSI Layer 2: Data-Link Layer', 'Layer 2: MAC addressing, switching, VLANs and ARP; MAC flooding, ARP poisoning and VLAN hopping, with port security and 802.1X.'),
    t('cissp_osi_l3', '4. OSI Layer 3: Network Layer', 'Layer 3: IP addressing, subnetting, routing and ICMP; spoofing and routing attacks, with ACLs, filtering and IPsec.'),
    t('cissp_osi_l4', '5. OSI Layer 4: Transport Layer', 'Layer 4: TCP and UDP, ports, the three-way handshake and session state; SYN floods, scanning and hijacking, with SYN cookies and stateful inspection.'),
    t('cissp_osi_l5', '6. OSI Layer 5: Session Layer', 'Layer 5: session establishment, maintenance and teardown; RPC, NetBIOS and session-layer authentication, replay and hijack defences.'),
    t('cissp_osi_l6', '7. OSI Layer 6: Presentation Layer', 'Layer 6: encoding, serialisation, compression and encryption placement; malformed-encoding and downgrade attacks.'),
    t('cissp_osi_l7', '8. OSI Layer 7: Application Layer', 'Layer 7: the application protocols themselves - HTTP, DNS, SMTP, FTP, SNMP - and the attacks and controls that live at the top of the stack.'),
    t('cissp_service_considerations', '9. Service Considerations', 'Converged services, quality of service, multimedia and voice, content distribution, and third-party connectivity.'),
    t('cissp_network_attacks', '10. Secure Network Components', 'Spoofing, sniffing, DDoS, and network IDS/IPS.'),
    t('cissp_protocols', '11. Secure Communications Channels According to Design', 'TLS, IPSec, VPNs, SSH, and secure email protocols.'),
    t('cissp_d4_review', '12. Domain 4 Review', 'Domain 4 consolidation - the layer-by-layer map, the traps, and a full-length review set.'),
  ]},
  { sectionId: 'd5_iam', sectionName: 'Domain 5: Identity and Access Management (13%)', topics: [
    t('cissp_access_control', '1. Control Physical and Logical Access to Assets', 'DAC, MAC, RBAC, ABAC, and rule-based access control.'),
    t('cissp_identity', '2. Identity and Access Provisioning Lifecycle', 'Provisioning, federation, SSO, credential management, and session management.'),
    t('cissp_auth', '3. Identification and Authentication of People, Devices, and Services', 'Knowledge, possession, biometric factors, and multi-factor authentication.'),
    t('cissp_idm_implementation', '4. Identity Management Implementation', 'Directory services, single sign-on, federation and identity-as-a-service; credential management systems and just-in-time provisioning.'),
    t('cissp_authz_mechanisms', '5. Implement and Manage Authorization Mechanisms', 'Applying DAC, MAC, RBAC, ABAC and risk-based authorisation in practice, including policy decision and enforcement points.'),
    t('cissp_accountability', '6. Accountability', 'Making actions attributable - unique identity, logging, monitoring, audit trail integrity and non-repudiation.'),
    t('cissp_d5_review', '7. Domain 5 Review', 'Domain 5 consolidation - the cross-module links, the traps, and a full-length review set.'),
  ]},
  { sectionId: 'd6_assessment', sectionName: 'Domain 6: Security Assessment and Testing (12%)', topics: [
    t('cissp_assess_strategy', '1. Design and Validate Assessment, Test, and Audit Strategies', 'Designing assessment, test and audit strategies for internal, external and third-party scope, and validating that they answer the risk question.'),
    t('cissp_vuln', '2. Security Control Testing', 'Scanning, penetration testing, and red/blue/purple team exercises.'),
    t('cissp_process_data', '3. Security Process Data', 'Operational data that evidences the programme - account management, backup verification, training records, KPIs and KRIs.'),
    t('cissp_test_reporting', '4. Test Output and Generate Report', 'Turning findings into a report an audience will act on: remediation tracking, exception handling, and reporting to management.'),
    t('cissp_audit', '5. Conduct or Facilitate Security Audits', 'Audit types, log review, SOC reports, and compliance testing.'),
    t('cissp_d6_review', '6. Domain 6 Review', 'Domain 6 consolidation - the cross-module links, the traps, and a full-length review set.'),
  ]},
  { sectionId: 'd7_operations', sectionName: 'Domain 7: Security Operations (13%)', topics: [
    t('cissp_operations', '1. Foundational Security Operations Concepts', 'Patch management, change management, configuration management, and monitoring.'),
    t('cissp_provisioning', '2. Securely Provisioning Resources', 'Asset inventory, configuration management, baselining and provisioning of physical and virtual resources through their lifecycle.'),
    t('cissp_resource_protection', '3. Resource Protection Techniques', 'Media management, hardware and software asset protection, and the controls that keep provisioned resources trustworthy.'),
    t('cissp_detective_preventative', '4. Detective and Preventative Measures', 'Firewalls, IDS and IPS, allow-listing, sandboxing, honeypots, anti-malware and machine-learning-based detection.'),
    t('cissp_ir', '5. Incident Management', 'Detection, response, containment, recovery, and post-incident review.'),
    t('cissp_investigation_types', '6. Requirements for Investigation Types', 'Administrative, criminal, civil, regulatory and industry-standard investigations, and the differing evidence standards each carries.'),
    t('cissp_investigations', '7. Investigations', 'Forensics, chain of custody, e-discovery, and evidence handling.'),
    t('cissp_logging_monitoring', '8. Logging and Monitoring Activities', 'Log sources and retention, SIEM aggregation and correlation, continuous monitoring, egress monitoring and threat intelligence.'),
    t('cissp_recovery_strategies', '9. Recovery Strategies', 'Backup storage strategies, recovery site selection, multiple processing sites, and system resilience and fault tolerance.'),
    t('cissp_disaster', '10. Disaster Recovery Processes', 'Recovery sites, backup strategies, and recovery testing.'),
    t('cissp_bcp_exercises', '11. Business Continuity Planning and Exercises', 'Building the continuity plan and exercising it - awareness, training and the exercise types that prove it works.'),
    t('cissp_dr_testing', '12. Test Disaster Recovery Plans', 'Read-through, walkthrough, simulation, parallel and full-interruption testing - what each proves and what each risks.'),
    t('cissp_personnel_safety', '13. Personnel Safety and Security Concerns', 'Duress, travel security, emergency management and the principle that life safety overrides every other control.'),
    t('cissp_d7_review', '14. Domain 7 Review', 'Domain 7 consolidation - the cross-module links, the traps, and a full-length review set.'),
  ]},
  { sectionId: 'd8_software', sectionName: 'Domain 8: Software Development Security (10%)', topics: [
    t('cissp_sdlc', '1. Security in the Software Development Lifecycle (SDLC)', 'Security in requirements, design, implementation, testing, and deployment.'),
    t('cissp_owasp_patterns', '2. Secure Coding Guidelines and Standards', 'OWASP Top 10 (2021/2024) per-item attack patterns and prevention. CWE/CVSS mapping, injection/XSS/deserialization defenses, secure coding patterns. CBK D8 expansion.'),
    t('cissp_devops', '3. Security Controls in Development Environments', 'CI/CD security, infrastructure as code, container security, and supply chain.'),
    t('cissp_software_effectiveness', '4. The Effectiveness of Software Security', 'Auditing and logging of change, risk analysis of acquired software, and assessing the security of purchased and open-source components.'),
    t('cissp_d8_review', '5. Domain 8 Review', 'Domain 8 consolidation - the cross-module links, the traps, and a full-length review set.'),
  ]},
];
