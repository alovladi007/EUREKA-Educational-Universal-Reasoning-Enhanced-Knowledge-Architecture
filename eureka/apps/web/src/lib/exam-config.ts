...
export const EXAM_CONFIGS: Record<string, ExamTypeConfig> = {
  ...
  PATENT_BAR: {
     ...
     * from the 611 official released-exam questions in the QBank and are kept
    ...
    sections: [
      ...
      { id: 'patentability', name: 'Patentability & Prior Art', questionCount: 27 },
      { id: 'post_issuance', name: 'Post-Issuance Proceedings', questionCount: 10 },
      { id: 'design_plant', name: 'Design & Plant Patents', questionCount: 1 },
