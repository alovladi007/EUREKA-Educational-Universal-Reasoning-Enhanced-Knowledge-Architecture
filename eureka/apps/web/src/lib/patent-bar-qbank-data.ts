...
export const PATENT_BAR_QUESTIONS: PatentBarQuestion[] = [
  ...
  },
  {
    ...
    options: ['There is no EFD because the provisional was insufficient', 'Dec 1 (nonprovisional date)', 'Jan 1 (provisional date)', 'The earliest of either'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Only applies if the use was patented in Japan', 'IS prior art (post-AIA, public use applies worldwide)', 'Is not prior art (geographic limit on public use)', 'Only applies if a US person was involved'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Triggers only the §102(b)(1)(A) grace period', 'Is not on-sale prior art under AIA', 'Is on-sale prior art only if the sale product publicly disclosed the invention', 'IS on-sale prior art under AIA, even if the sale was secret'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['A §132 declaration', 'A petition under §1.181', 'A §1.130 declaration attesting to the inventor\'s disclosure', 'A formal request for reconsideration'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['To all claims based on the CIP filing date', 'To each claim based on the EFD that supports it under §112(a)', 'To all claims equally based on the parent filing date', 'Based on the inventor\'s first conception date'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['EPO and Japan have similar 1-year grace periods', 'Foreign filings can claim the same shield as the US filing', 'Pre-filing disclosure is generally fatal to patentability in most foreign jurisdictions', 'The grace period applies worldwide'],
    correct: 2,
  ...
  // ── pa_aia_102a2_secret_prior_art (8 questions) ─────────────
  {
    ...
    options: ['The earliest effective filing date (EFD) of the other application', 'The date the application becomes publicly available', 'The publication date of the application', 'The grant date if it issues'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['As of A\'s publication date (July 2023)', 'As of A\'s US filing date (Jan 1, 2022)', 'Never (publication came after B\'s filing)', 'As of A\'s foreign priority date (March 1, 2021)'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Both applications being assigned to a non-profit', 'Filing within 6 months of the prior application\'s filing', 'Common ownership of the subject matter and claimed invention by the EFD of the claimed invention', 'Derivation by the inventor'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['The §102(c) JRA exception requires disclosure of the parties in the application', 'Without the JRA, the university\'s February application would be §102(a)(2) prior art against the company\'s June application', 'The JRA disqualifies the university\'s application from being §102(a)(2) prior art against the company\'s application', 'All of the above'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Its publication date by WIPO', 'Its international filing date (or any priority date claimed)', 'It is never §102(a)(2) prior art', 'Only its US national stage entry date'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['The subject matter was obtained directly or indirectly from the inventor of the claimed invention', 'Both inventors filed within the same month', 'Both applications are commonly owned at any point in time', 'The patent has been licensed exclusively'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['§102(a)(1) prior art if it later publishes', 'Used for §112 rejection', 'Permanently excluded from any consideration', 'Used for novelty rejection'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['§1.130 declaration', 'Petition under §1.181', '§1.131 declaration', '§1.132 declaration'],
    correct: 0,
  ...
  // ── pa_112f_means_plus_function (8 questions) ──────────────
  {
    ...
    options: ['Means-plus-function claims are presumed valid', 'All software claims are subject to §112(f)', 'Non-"means" language with a generally understood structural meaning escapes §112(f)', 'Nonce words like "module" routinely trigger §112(f) interpretation'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['An ALGORITHM (flowchart, prose, or pseudocode) for the function', 'Only the function performed', 'A general-purpose computer', 'The hardware specifications'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['The structure most commonly used in the art', 'Any structure that performs the recited function', 'Whatever the applicant claims at any time', 'Only the corresponding structure in the specification, plus equivalents'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['"module configured to store data"', '"a non-volatile flash memory storing data"', '"unit configured to store data"', '"means for storing data"'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['The time of license execution', 'The time of patent issuance', 'The time of filing the application', 'The time of infringement'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Cancel all the claims', 'Immediately appeal to PTAB', 'Add new structure to the specification', 'Argue that the claim term has structural meaning, AND consider amending claim to specific structural language'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Applicant intent to use §112(f)', 'Modified by sufficient structure', 'Uses "means" or "step for" (or nonce word)', 'Modified by functional language'],
    correct: 0,
  ...
  // ── pa_terminal_disclaimer_odp (8 questions) ────────────────
  {
    ...
    options: ['Only statutory DP can be cured by TD; ODP requires claim amendment', 'Both can be cured by terminal disclaimer', 'Only ODP can be cured by TD; statutory DP requires claim amendment', 'Neither can be cured by TD'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Permanently waives all enforcement rights', 'Aligns expiration of the later patent with the earlier patent AND requires common ownership for enforceability', 'Reduces the patent term measured from filing date', 'Is only available during prosecution'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['TD is mandatory for any divisional', 'The safe harbor applies even to improperly restricted applications', 'Claims that were properly elected/divided cannot be cited against each other under ODP', 'TD is required when the divisional is filed'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Only for design patents', 'Whenever there is any ODP rejection', 'Only when the USPTO caused delay in examining the earlier application', 'Only when the patents involve different inventors'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Eliminates the need to file a continuation', 'Provides immunity from inequitable conduct', 'Cancels the earlier patent', 'Aligns the expiration of the pending application with the earlier-issued patent\'s expiration'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Is automatically granted if filed within 2 years', 'Triggers automatic ODP review against the original patent', 'Is barred by the recapture doctrine if the surrender was deliberate to overcome prior art', 'Requires automatic TD filing'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Issue of the second patent only', 'All times during enforcement of both patents', 'Filing of the second application only', 'Filing of the first application only'],
    correct: 1,
  ...
  // ── pp_claim_antecedent_basis (8 questions) ──────────────
  {
    ...
    options: ['"first body" if multiple', '"a body" or "an body" introduction', '"said body" reference', '"the body" reference'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Properly antecedent', 'Permitted because both bodies have smooth surfaces', 'A drafting style choice without legal consequence', 'Indefinite (Packard rule) — ambiguous which body is referenced'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['The claim is limited to the recited elements plus their equivalents', 'The claim is limited to ONLY the recited elements', 'The claim is limited to non-material additions', 'The claim covers structures with at least the recited elements (open-ended)'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['"selected from the group consisting of: A, B, C"', 'any of the above', '"chosen from A, B, C"', '"selected from"'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Only the claim it depends from', 'Only the independent claim it ultimately depends from', 'The parent claim CHAIN (chain of dependents)', 'Any claim in the application'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Independent claims always cover infringement', 'Multiple claims indicate inventive concept', 'Dependent claims are presumed broader than independent', 'Different claims must have different scope'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Two claims (the multiple + one base)', 'One claim', 'Five claims (per alternative)', 'Six claims (per alternative plus the base)'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Multiple sentences with proper punctuation', 'Bullet points', 'One sentence per claim, ending with a period', 'Numbered subparts using letters'],
    correct: 2,
  ...
  // ── pp_ids_therasense_materiality (8 questions) ─────────────
  {
    ...
    options: ['Fee only', 'Fee + certification', 'Certification only', 'Neither fee nor certification'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Certification only', 'Fee only', 'No fee', 'BOTH fee and §1.97(e) certification'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Only the attorney of record', 'Anyone substantively involved in the preparation or prosecution', 'Only persons under specific contract', 'Only the named inventors'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Negligence in disclosure', 'Both BUT-FOR materiality AND specific intent to deceive by clear and convincing evidence', 'Materiality OR specific intent to deceive', 'Knowledge of the reference\'s existence'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['File the IDS within 3 months of receiving the foreign communication, with §1.97(e) certification', 'File the IDS within 1 year of foreign office action', 'File the IDS within 30 days of US filing', 'File the IDS only at the next non-final office action'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Reasonable likelihood of materiality', 'Establishes prima facie case OR refutes applicant\'s position', 'Cumulative reference standard', 'But-for materiality (would examiner have allowed)'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['All claims of the patent unenforceable', 'The patent automatically invalid for the term of the patent', 'Only the patent owner subject to sanctions', 'Only the affected claims invalid'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Wait until office actions to assess references', 'Disclose only references that are clearly material', 'Disclose all known references, including potentially cumulative ones', 'Avoid disclosing foreign office citations'],
    correct: 2,
  ...
  // ── pp_inventorship_correction (6 questions) ────────────────
  {
    ...
    options: ['Conceives the invention', 'Implements the invention\'s design as a technician', 'Reduces an invention to practice', 'Funds the inventor\'s work'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Contribute to at least one claim', 'Be employed by the same entity', 'Work in person at the same time and place', 'Contribute to every claim'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Pre-existing assignment', 'Statement that the error occurred without deceptive intent', 'Court order', 'Both inventors\' agreement and a court order'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Required automatically at maintenance fee', 'Pursued only through litigation', 'Made only within 1 year of issue', 'Made by court order OR direct application to USPTO if no dispute'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Inventors who lost a race to file', 'An applicant or patentee who alleges the claimed subject matter was derived from them', 'Anyone with prior knowledge of the invention', 'Third parties with standing'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Prior commercial use', 'Earlier filing date', 'Independent invention', 'Conception by petitioner AND communication to the alleged deriver'],
    correct: 3,
  ...
  // ── pf_priority_paris_120 (8 questions) ─────────────────────
  {
    ...
    options: ['24 months of the foreign filing', '18 months of the foreign filing', '6 months of the foreign filing', '12 months of the foreign filing'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Within 4 months of US filing OR 16 months of priority (whichever LATER)', 'Within 3 months of US filing', 'With the US application', 'Within 6 months of US filing'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Restoration is available within 2 months of the missed deadline with showing of UNINTENTIONAL delay', 'Restoration is available with showing of unavoidable delay', 'Restoration is not available', 'Restoration requires filing a new application without benefit'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Matures into a patent if not converted within 12 months', 'Requires §112(a) support of all claims in the future nonprovisional', 'Must be filed in English only', 'Does not require claims and provides 12-month priority to a nonprovisional'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Filing within 4 months of parent', 'Filing exactly on the parent\'s 1-year anniversary', 'PENDENCY of parent (not abandoned or issued), common inventor, and specific reference to parent', 'Identical claims to the parent'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['20 years from 1/1/2010 (earliest filing in chain)', 'No term limit if multiple continuations', '20 years from 1/1/2018', '20 years from 1/1/2014'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Anytime during prosecution', '4 months of US filing OR 16 months of priority (whichever LATER)', '24 months of priority', '12 months of US filing'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Neither', 'Prior art evaluation only', 'Both patent term and prior art evaluation', 'Patent term only'],
    correct: 1,
  ...
  // ── pf_rce_vs_continuation_strategy (8 questions) ──────────
  {
    ...
    options: ['Is mandatory after every final office action', 'Creates a new application with new serial number', 'Continues the same application without changing serial number', 'Triggers a new patent term'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['RCE keeps the application alive; continuation creates a new application', 'RCE has shorter time limits', 'RCE requires new inventors; continuation does not', 'RCE is free; continuation has a fee'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['File an RCE', 'File a divisional', 'File a continuation', 'Neither — the application is essentially closed'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['It has a different filing date from the parent', 'It only applies to method patents', 'It is filed in response to a restriction requirement and has §121 safe harbor against ODP', 'It can have different inventors than the parent'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['The parent\'s filing date for parent-supported claims; CIP date for new-matter claims', 'Whatever date the applicant claims', 'The earlier of the two dates for all claims', 'The CIP filing date for all claims'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['RCEs trigger a new 20-year clock', 'RCEs are categorized as applicant delay (or B-delay reduction)', 'RCEs are exempt from PTA calculation', 'RCEs are categorized as A-delay'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['When minor cleanup is sufficient', 'When the applicant wants to keep the same serial number', 'When the application is in its first prosecution round', 'When the prosecution needs major redirection or PTA is critical'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['The parent must be at least 6 months old', 'The parent must be active — not yet abandoned or issued', 'The parent must be approved', 'The parent must have received an office action'],
    correct: 1,
  ...
  // ── pf_restriction_elections_detailed (8 questions) ────────
  {
    ...
    options: ['The application has multiple inventors', 'Claims are different products', 'Claims are independent and distinct AND a serious search burden would result', 'Claims are filed in a continuation'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Electing one invention AND preserving the right to challenge whether restriction was proper', 'Filing both elected and non-elected claims', 'Abandoning the non-elected claims permanently', 'Accepting the restriction without challenge'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['The restriction is automatically withdrawn', 'The amendment is automatically rejected', 'The new claims must be filed in a divisional', 'The applicant has effectively elected Group B by ORIGINAL PRESENTATION'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Filing a divisional within 6 months of issue', 'Filing a continuation instead of a divisional', 'Both inventions being assigned to a non-profit', 'Proper restriction + election WITH traverse + divisional filed before parent issues'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['§103 obviousness', 'Any prior art rejection', 'Obviousness-type double patenting (ODP) only', 'All double patenting (statutory + ODP)'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['The restriction is automatically withdrawn', 'All claims are rejected', 'The application is treated as if the first group listed was elected (provisional election)', 'The application is abandoned'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['A single generic claim covers all species', 'The application has multiple inventors', 'Multiple species are claimed without a generic claim', 'The inventor is not a US citizen'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Reopen prosecution with an RCE', 'Only appeal to the Federal Circuit', 'File a petition under §1.144 to the Director within 2 months', 'Withdraw the application'],
    correct: 2,
  ...
  // ── po_ptab_appeal_practice (8 questions) ──────────────────
  {
    ...
    options: ['After any office action', 'Only after a final office action', 'After two or more rejections in the same application', 'Only after a notice of allowance'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['2 months (extendable up to 5)', '30 days', '6 months', '1 year'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['The broadest reasonable interpretation (BRI) consistent with spec', 'No formal claim construction standard', 'A combination of both', 'The Phillips construction'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Within 30 days', 'Within 1 month with amendments only', 'Within 2 months by reply brief OR reopen prosecution', 'Within 6 months by petition'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Showing the PTAB misapprehended a point of law or fact, or overlooked a key argument', 'Any reasonable disagreement with the decision', 'Court order required', 'Filed within 6 months of decision'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['To the USPTO Director', 'To the Federal Circuit within 2 months', 'No further appeal is available', 'To the Supreme Court directly'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['An informal review by a panel before formal appeal', 'Mandatory before a formal appeal', 'A replacement for the appeal brief', 'Available only for first-time applicants'],
    correct: 0,
  ...
  // ── pi_ipr_pgr_cbm_distinctions (8 questions) ───────────────
  {
    ...
    options: ['Any patentability ground', '§101 and §112', '§102 and §103 only, based on patents and printed publications', 'Inventorship and ownership disputes'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['9 months of issue', 'Any time after issue', '6 months of issue', '1 year of issue'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Grounds raised OR that could have been raised', 'Anything related to the patent', 'Only grounds actually raised', 'Only grounds the PTAB rejected'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Still available today for any patent', 'Replaced by PGR for all patent types', 'Only available for financial business method patents, and sunset on September 16, 2020', 'Permanently available for software patents'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Substantial evidence', 'Beyond reasonable doubt', 'Clear and convincing evidence', 'Preponderance of the evidence'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Only patent owners can file', 'Yes, like federal court litigation', 'Only assignees can file', 'No — any party (except patent owner) can file'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['CBM applied to all patents', 'CBM estoppel covered only grounds LITERALLY RAISED (not "could have raised")', 'CBM had longer time limits', 'It was retroactive'],
    correct: 1,
  ...
  // ── pi_reissue_reexam_supplemental (8 questions) ───────────
  {
    ...
    options: ['Anytime during the patent term', 'Within 2 years of the original patent issue', 'Only during prosecution', 'Within 1 year of issue'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Patenting design improvements', 'Any narrowing reissue', 'Filing continuation applications', 'Recovering subject matter deliberately surrendered during original prosecution to overcome prior art'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['§102 and §103 over patents and printed publications', 'Any patentability ground', 'Inventorship correction', '§112 only'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['A substantial new question of patentability (SNQ)', 'Clear and convincing evidence of invalidity', 'Reasonable likelihood of unpatentability', 'A petition with proper fees'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Federal Circuit judges', 'Third parties', 'Patent owners', 'USPTO examiners'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Inability to file continuation', 'Term extension', 'IMMUNITY from inequitable conduct claims based on the submitted information', 'Automatic license to all parties'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Act after the patent issues', 'File petitions in PTAB', 'Act before reissue/reexam, where the claims are subsequently amended', 'Are licensed by the patent owner'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['PGR', 'Reissue', 'Supplemental examination', 'Ex parte reexamination'],
    correct: 2,
  ...
  // ── pct_chapter_ii_preliminary (6 questions) ────────────────
  {
    ...
    options: ['30 months from priority', '24 months from priority', '12 months from priority', '22 months from priority OR 3 months from ISR transmittal (whichever LATER)'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Claims and description', 'Drawings only', 'Claims only', 'Claims, description, and drawings'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Are filed with the IB', 'Are limited to the claims', 'Allow amendments to claims, description, and drawings; filed with IPEA', 'Become part of the international publication'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Filed by the applicant', 'Binding on national patent offices', 'Required for all PCT applications', 'Advisory only, but provides examination history for national stage'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Patent term only', 'Whether Chapter II is available', 'The PCT filing date', 'Fees, examination quality, and influence on national stage examinations'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['When the ISR was favorable and no amendments needed', 'When only one national stage will be filed', 'When budget is constrained', 'When the ISR cited significant prior art and you want to refine claims before national stage'],
    correct: 3,
  ...
  // ── pct_national_stage_371 (8 questions) ────────────────────
  {
    ...
    options: ['36 months from priority', '20 months from priority', '12 months from PCT filing', '30 months from earliest priority date'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Only the international application', 'Only the national fee', 'National fee, English translation if needed, oath/declaration, and proper ADS', 'Just the priority documents'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Independent PTA clock and full flexibility of US prosecution', 'Automatic patent term extension', 'Lower fees and same examination', 'Mandatory for biotech applications'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['20 years from US national stage entry', '17 years from US issue', '20 years from PCT filing', '20 years from earliest US filing in the chain (or PCT)'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['Not available at all', 'Within 1 year', 'Within 2 months of the missed deadline with showing of unintentional delay', 'Within 6 months of the missed deadline'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['Spanish-speaking examiner assignment', 'No translation', 'Verified English translation by 30 months', 'Filing in both Spanish and English'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['When the application is biological in nature', 'When the PCT was filed in a non-English language', 'When the applicant is a foreign entity', 'When inventor changes are needed or independent PTA accumulation is desired'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['As a national stage entry (§371)', 'Only after PCT publication', 'As a US §111(a) application claiming benefit of the PCT', 'With the IB'],
    correct: 2,
  ...
  // ── st_pta_calculation_abc (8 questions) ────────────────────
  {
    ...
    options: ['Delays caused by the applicant', 'Delays in USPTO\'s response to applicant filings', 'Delays caused by appeals', 'Total pendency over 3 years'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Inventorship disputes', 'USPTO response delays', 'Interferences only', 'Patent issue not within 3 years of filing (excluding specific exclusions)'],
    correct: 3,
  ...
  },
  {
    ...
    options: ['A + B - Applicant Delay', 'A + B + C - Applicant Delay - Overlap', 'A + B + C', 'A - B + C'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['B-delay (pendency)', 'Applicant delay (reducing PTA)', 'A-delay (USPTO\'s fault)', 'No effect on PTA'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Within 2 months of patent issuance', 'Within 30 days of issuance', 'Anytime during the patent term', 'Within 1 year of issuance'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Applicant delay days overlap with USPTO delays', 'Each calendar day is counted ONCE in the total PTA calculation', 'Overlapping days are not counted at all', 'Days can be counted in multiple A/B/C categories'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Total examination time', 'Time consumed by interferences/derivations, secrecy orders, or appellate review', 'Time spent on RCEs', 'Applicant delays'],
    correct: 1,
  ...
  // ── st_pte_hatch_waxman (6 questions) ───────────────────────
  {
    ...
    options: ['Any technology', 'Drug products, devices, and certain regulated products subject to FDA review', 'Manufacturing methods', 'Software inventions'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['At the time of patent filing', 'Within 60 days of FDA approval', 'Within 90 days of patent expiration', 'Within 1 year of patent issuance'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['Just the approval phase', 'Approval phase + (Testing phase / 2) - Applicant delays', 'Just the testing phase', 'Approval phase + Testing phase'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['No caps', '20 years from issue', '5 years maximum extension AND 14 years from FDA approval maximum total term', 'Maximum 1 year, no other limits'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['One patent per product', 'All patents owned by the applicant', 'Every patent covering the product', 'The patent with the broadest claims'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Only available for biologics', 'Independent extensions that can stack', 'The same — one extends both for USPTO and FDA delays', 'Mutually exclusive'],
    correct: 1,
  ...
  // ── st_maintenance_fees (6 questions) ───────────────────────
  {
    ...
    options: ['3.5, 7.5, and 11.5 years from issue', '5, 10, and 15 years from issue', '1, 4, and 8 years from issue', '5 and 10 years from issue'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Opens 6 months before due date AND closes at the due date', 'Is one year long', 'Closes at the maintenance fee due date', 'Has no closing date'],
    correct: 0,
  ...
  },
  {
    ...
    options: ['Requires court order', 'Allows payment with a surcharge', 'Is not available', 'Is automatically granted'],
    correct: 1,
  ...
  },
  {
    ...
    options: ['The owner pays double the maintenance fee', 'The patent is over 10 years old', 'The failure to pay was UNINTENTIONAL', 'The owner provides written notice'],
    correct: 2,
  ...
  },
  {
    ...
    options: ['25% of standard fees', 'No fees', '50% of standard fees', '100% of standard fees'],
    correct: 2,
