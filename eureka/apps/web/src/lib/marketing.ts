...
export const PROGRAMS: Program[] = [
  {
    ...
    blurb: '1,564-question QBank built on 758 official USPTO exam questions, timed real-exam mocks, and an MPEP workbench.',
    href: '/patent-bar',
    ...
    detail: {
      ...
      inside: [
        { title: '1,564-question QBank', desc: '758 official USPTO exam questions plus original items mapped to the MPEP, every one with a cited explanation.' },
