...
export const PROGRAMS: Program[] = [
  {
    ...
    blurb: '1,029-question QBank built on 223 official USPTO exam questions, timed real-exam mocks, and an MPEP workbench.',
    href: '/patent-bar',
    ...
    detail: {
      ...
      inside: [
        { title: '1,029-question QBank', desc: '223 official USPTO exam questions plus original items mapped to the MPEP, every one with a cited explanation.' },
      ...
      specs: [
        ['QBank size', '1,029 questions'],
        ['Official USPTO items', '223'],
