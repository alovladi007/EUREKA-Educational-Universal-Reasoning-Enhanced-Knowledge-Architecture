...
export const PROGRAMS: Program[] = [
  {
    ...
    blurb: '980-question QBank built on 174 official USPTO exam questions, timed real-exam mocks, and an MPEP workbench.',
    href: '/patent-bar',
    ...
    detail: {
      ...
      inside: [
        { title: '980-question QBank', desc: '174 official USPTO exam questions plus original items mapped to the MPEP, every one with a cited explanation.' },
      ...
      specs: [
        ['QBank size', '980 questions'],
        ['Official USPTO items', '174'],
