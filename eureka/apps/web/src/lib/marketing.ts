...
export const PROGRAMS: Program[] = [
  {
    ...
    blurb: '1,126-question QBank built on 320 official USPTO exam questions, timed real-exam mocks, and an MPEP workbench.',
    href: '/patent-bar',
    ...
    detail: {
      ...
      inside: [
        { title: '1,126-question QBank', desc: '320 official USPTO exam questions plus original items mapped to the MPEP, every one with a cited explanation.' },
      ...
      specs: [
        ['QBank size', '1,126 questions'],
        ['Official USPTO items', '320'],
