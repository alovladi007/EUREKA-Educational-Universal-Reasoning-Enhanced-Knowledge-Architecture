...
export const PROGRAMS: Program[] = [
  {
    ...
    blurb: '1,515-question QBank built on 709 official USPTO exam questions, timed real-exam mocks, and an MPEP workbench.',
    href: '/patent-bar',
    ...
    detail: {
      ...
      inside: [
        { title: '1,515-question QBank', desc: '709 official USPTO exam questions plus original items mapped to the MPEP, every one with a cited explanation.' },
