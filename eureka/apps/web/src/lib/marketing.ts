...
export const PROGRAMS: Program[] = [
  {
    ...
    blurb: '1,078-question QBank built on 272 official USPTO exam questions, timed real-exam mocks, and an MPEP workbench.',
    href: '/patent-bar',
    ...
    detail: {
      ...
      inside: [
        { title: '1,078-question QBank', desc: '272 official USPTO exam questions plus original items mapped to the MPEP, every one with a cited explanation.' },
      ...
      specs: [
        ['QBank size', '1,078 questions'],
        ['Official USPTO items', '272'],
