...
export const PROGRAMS: Program[] = [
  {
    ...
    blurb: '1,368-question QBank built on 562 official USPTO exam questions, timed real-exam mocks, and an MPEP workbench.',
    href: '/patent-bar',
    ...
    detail: {
      ...
      inside: [
        { title: '1,368-question QBank', desc: '562 official USPTO exam questions plus original items mapped to the MPEP, every one with a cited explanation.' },
