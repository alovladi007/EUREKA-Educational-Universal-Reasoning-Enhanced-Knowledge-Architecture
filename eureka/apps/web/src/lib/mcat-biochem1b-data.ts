...
![Rate enhancement versus reduction of the activation barrier, computed from rate factor = 10^(ΔΔG‡/5.7) at 25 °C, with the tabulated enhancements of five real enzymes marked from cyclophilin (10⁵) to OMP decarboxylase (10¹⁷). Every 5.7 kJ/mol taken off the barrier buys another factor of ten in rate.](/courses/mcat/biochem/bc1-rate-vs-barrier.svg)`,
        examTip:
...
![Chymotrypsin's bell-shaped pH-activity profile, computed as the product of two Henderson-Hasselbalch terms: His57 must be deprotonated (pKa ≈ 7) and the Ile16 α-amino group must stay protonated (pKa ≈ 8.8). The computed optimum lands at their average, pH 7.9.](/courses/mcat/biochem/bc1-chymotrypsin-ph.svg)`,
        quiz: [
          {
            question:
...
![Velocity versus substrate concentration for an uninhibited enzyme and the competitive, uncompetitive, and mixed inhibition patterns, computed from v = Vmax[S]/(αKm + α′[S]) with the illustrative parameters Vmax = 100, Km = 2, and α = α′ = 2. Only the competitive curve still climbs toward the full Vmax at high substrate; the others plateau at Vmax/α′.](/courses/mcat/biochem/bc1-inhibition-rates.svg)
...
![Fractional saturation computed from the Hill equation for n = 1, 2, 2.8, and 4. Every curve half-saturates at [S] = K₀.₅ by construction; raising n steepens the middle of the curve, turning the n = 1 hyperbola into an increasingly switch-like sigmoid.](/courses/mcat/biochem/bc1-hill-family.svg)
...
![Rate curves for hexokinase and glucokinase computed from v/Vmax = [glucose]/(Km + [glucose]) with the standard Km values, 0.05 mM and 10 mM, and the normal blood-glucose band (4.5–5.5 mM) shaded. At 5 mM glucose, hexokinase runs at 0.99 of Vmax — saturated and blind to the band — while glucokinase sits at 0.33 of Vmax on its rising slope, tracking blood glucose.](/courses/mcat/biochem/bc1-hexokinase-glucokinase.svg)
