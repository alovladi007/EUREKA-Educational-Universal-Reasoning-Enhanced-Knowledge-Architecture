...
export const MCAT_FOUNDATIONAL_CONCEPTS: McatTopic[] = [
  // Bio/Biochem section — FC1, FC2, FC3 split the section roughly equally
  {
  ...
  // CARS section — skills-based, no FCs
  {
  ...
  // Psych/Soc section — FC6 through FC10
  {
