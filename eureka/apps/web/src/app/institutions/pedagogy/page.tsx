...
/**
 * Partner Portal · Evidence · Learning model — how EUREKA teaches, presented
 * as auditable evidence for institutional buyers (moved here from the learner
 * sidebar in 2026-08; /dashboard/pedagogy redirects).
 *
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          How EUREKA teaches, as evidence: the instructional design behind the
          platform, with every count pulled live from the production skill
          graph — nothing on this page is a marketing figure.
        </p>
      </div>
