 ...
 *    items (fourteen released sessions, Apr 2000 through Oct 2003, graded
...
export default function PatentBarMockPage() {
  ...
  useEffect(() => {
    (async () => {
      const [octAm, octPm, aprAm, aprPm, apr02Am, apr02Pm, oct01Am, oct01Pm, apr01Am, apr01Pm, oct00Am, oct00Pm, apr00Am, apr00Pm] = await Promise.all([
        ...
        <Card className="space-y-3 p-5 text-sm">
          ...
          <p className="flex items-start gap-2 rounded-md border border-emerald-500/40 bg-emerald-500/5 p-3">
            ...
            <span>
              ...
              USPTO released-exam questions drawn from fourteen released sessions (Apr 2000 through
