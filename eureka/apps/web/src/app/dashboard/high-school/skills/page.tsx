...
/**
 * /dashboard/high-school/skills — skill mastery + recommendations for the
 * HS tier, filtered to NGSS / CCSS / AP frameworks. Parallel to
...
export default function HighSchoolSkillsPage() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Where you stand vs the {FRAMEWORKS.length} high-school frameworks
          (NGSS, CCSS, AP). Live from{" "}
            ...
            <CardHeader>
              ...
              <CardDescription>
                {recs.length === 0
                  ...
                  : `${recs.length} suggestions filtered to ${FRAMEWORKS.join(", ")}.`}
              </CardDescription>
            </CardHeader>
            {recs.length > 0 && (
              <CardContent>
