...
const SUBHEAD =
  "Real-time view of your medical-school tier (USMLE / MBE) — courses, recommendations, and skill mastery, all driven by the live API.";
const FRAMEWORKS = ["USMLE_Step_1", "USMLE_Step_2"];
