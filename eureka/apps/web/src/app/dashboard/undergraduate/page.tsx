...
/**
 * /dashboard/undergraduate — Overview tab of the undergrad module.
 *
 * Previously this was a single mega-page that crammed every section (full
 * course list, full skills detail, recommendations, resources, community,
 * enrolment) into one scroll. Now it's a real overview: stats grid that
 * doubles as CTAs into the sub-tabs (Courses / Enrollment / Skills /
 * Resources) defined in ./layout.tsx, plus an enrolment summary if you
 * have one. Mirrors the graduate overview (../graduate/page.tsx) shape.
 */
...
export default function UndergraduateOverview() {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-muted-foreground">
                Your undergrad work — courses, tier enrolment, skill mastery,
                and resources — all in one place. Tabs above let you drill in.
              </p>
      ...
      <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
        <Link href="/dashboard/undergraduate/courses">
        ...
        <Link href="/dashboard/undergraduate/skills">
          <Card className="h-full hover:border-primary/40 transition-colors cursor-pointer">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
        ...
        <Link href="/dashboard/undergraduate/resources">
          <Card className="h-full hover:border-primary/40 transition-colors cursor-pointer">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
