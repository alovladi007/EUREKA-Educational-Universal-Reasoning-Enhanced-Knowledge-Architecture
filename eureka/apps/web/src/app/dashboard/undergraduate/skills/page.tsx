...
/**
 * /dashboard/undergraduate/skills — skill mastery + recommendations for the
 * undergrad tier. Extracted from the original mega-page.
 */
...
export default function UndergradSkillsPage() {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Where you stand vs the {FRAMEWORKS.length} undergrad accreditation
          frameworks. Live from{" "}
        ...
        <>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {skills.length === 0
                  ? "No data yet — answer a few practice questions to seed your mastery profile."
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {recs.length === 0
                  ? "No recommendations yet. Practice a few questions and they'll show up here."
                  : `${recs.length} skills the recommender suggests you focus on, filtered to ${FRAMEWORKS.join(", ")}.`}
              </CardDescription>
            </CardHeader>
            {recs.length > 0 && (
              <CardContent>
