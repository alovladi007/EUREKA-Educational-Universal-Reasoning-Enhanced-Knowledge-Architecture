...
| nclex-phase1-wave11.json | 24 | 2026-08-20 | Safety & Infection Control +8, Reduction of Risk +8, Physiological Adaptation +8 (3 SATA): TB airborne, C. diff soap-and-water, sterile field, RACE, needlestick, home O2, pediatric identifiers, restraint standards; pre-op warfarin, DVT no-massage, central-line Valsalva, chest-tube air leak, transfusion reaction, seizure care, hypoglycemia vs DKA, post-cath hematoma; HF daily weights, COPD 88-92%, early ICP = LOC, inhalation injury, sickle cell, lactulose endpoint, right vs left HF, PD peritonitis; bank 393 |
