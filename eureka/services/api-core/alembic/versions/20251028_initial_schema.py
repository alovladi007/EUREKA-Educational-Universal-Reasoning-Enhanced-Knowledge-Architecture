...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('tier', postgresql.ENUM('high_school', 'undergraduate', 'graduate', 'professional_medical', 'professional_law', 'professional_mba', 'professional_engineering', name='tiertype', create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('role', postgresql.ENUM('super_admin', 'org_admin', 'teacher', 'student', 'parent', name='userrole', create_type=False), nullable=False),
