...
api_router.include_router(passport.router, tags=["skill-passport"])
...
api_router.include_router(cross_vertical.router, tags=["cross-vertical"])
...
api_router.include_router(exam_attempts.router, tags=["exam-attempts"])
