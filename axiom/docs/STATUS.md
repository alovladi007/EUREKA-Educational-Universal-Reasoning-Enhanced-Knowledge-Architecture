...
| notifications | done (in-app) | Phase 2 roadmap | In-app inbox and unread badge, emitted on assignment, badge earned, and AI-grade override, plus beat-scheduled due-date reminders. Email and push delivery are not built. |
