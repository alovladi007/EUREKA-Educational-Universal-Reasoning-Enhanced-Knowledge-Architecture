...
/**
 * The platform helper, inside AXIOM.
 *
 ...
 * only the AXIOM dress: brand colours, the module's own Card idiom.
 *
 * WHAT IT IS NOT FOR
 *
 * Mathematics questions. Those belong to the tutor on /copilot, which is
 * grounded in the lessons and knows the learner's mastery. This answers "how
 * do I use this thing" - where practice is, why a chapter says reading only,
 * how to get back to EUREKA - and hands anything else to a person.
 */
  ...
  return (
    <>
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
        aria-controls="axiom-help-panel"
      ...
      {open && (
        ...
        >
          <div className="flex items-center justify-between border-b border-border px-4 py-3">
            <div className="min-w-0">
              ...
              <p className="text-xs text-muted-foreground">
                Using AXIOM and EUREKA. For mathematics itself, ask the Copilot.
              </p>
            </div>
            <button
              type="button"
          ...
          >
            <label className="sr-only" htmlFor="axiom-help-question">
              Your question
            </label>
            <textarea
              id="axiom-help-question"
              ref={inputRef}
              rows={1}
              value={question}
